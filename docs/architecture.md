...
tests/fixtures/              # basic-config / build-plugins / build-steps-config / registry-plugins / cargo-git-lock / treesitter-config / unbuildable-config / local-plugin / empty-config / merge / merge-config / defaults-version-config / defaults-version-false-config / semver / update / import-lazy-lock / dev-plugins / source-urls / golden/
```
